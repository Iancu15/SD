...
static char *test_minmax() {
	...
	sd_assert("Problema2 - Test1 min picat", min == -8);
	sd_assert("Problema2 - Test1 max picat", max == 12);
	freeTree(&tree);
	...
	sd_assert("Problema2 - Test2 min picat", min == 1);
	sd_assert("Problema2 - Test2 max picat", max == 35);
	freeTree(&tree);
	...
	sd_assert("Problema2 - Test3 min picat", min == 4);
	sd_assert("Problema2 - Test3 max picat", max == 200);
	freeTree(&tree);
...
static char *test_delete() {
	...
	sd_assert("Problema3 - Test1 delete picat", height(tree) == 4 && tree != NULL && checkBST(tree) && !contains(tree, value));
	freeTree(&tree);
	...
	sd_assert("Problema3 - Test2 delete picat", height(tree) == 5 && tree != NULL && checkBST(tree) && !contains(tree, value));
	freeTree(&tree);
	...
	sd_assert("Problema3 - Test3 delete picat", height(tree) == 6 && tree != NULL && checkBST(tree) && !contains(tree, value));
	freeTree(&tree);
...
static char *test_lca() {
	...
	sd_assert("Problema4 - Test3 lca picat", lca == 35);
	freeTree(&tree);
...
static char *test_successor() {
	...
	sd_assert("Problema5 - Test1 successor picat", succ != NULL && succ->value == 4);
	succ = successor(tree, 6);
	printf("%d\n",succ->value);
	sd_assert("Problema5 - Test2 successor picat", succ != NULL && succ->value == 7);
	succ = successor(tree, 7);
	sd_assert("Problema5 - Test3 successor picat", succ != NULL && succ->value == 8);
	succ = successor(tree, 12);
	sd_assert("Problema5 - Test4 successor picat", succ == NULL);
	freeTree(&tree);
	...
	sd_assert("Problema5 - Test5 successor picat", succ != NULL && succ->value == 5);
	succ = successor(tree, 8);
	sd_assert("Problema5 - Test6 successor picat", succ != NULL && succ->value == 9);
	succ = successor(tree, 12);
	sd_assert("Problema5 - Test7 successor picat", succ != NULL && succ->value == 25);
	succ = successor(tree, 9);
	sd_assert("Problema5 - Test8 successor picat", succ != NULL && succ->value == 12);
	succ = successor(tree, 35);
	sd_assert("Problema5 - Test9 successor picat", succ == NULL);
	freeTree(&tree);
	...
	sd_assert("Problema5 - Test10 successor picat", succ != NULL && succ->value == 9);
	succ = successor(tree, 68);
	sd_assert("Problema5 - Test11 successor picat", succ != NULL && succ->value == 90);
	succ = successor(tree, 47);
	sd_assert("Problema5 - Test12 successor picat", succ != NULL && succ->value == 50);
	succ = successor(tree, 35);
	sd_assert("Problema5 - Test13 successor picat", succ != NULL && succ->value == 37);
	succ = successor(tree, 200);
	sd_assert("Problema5 - Test14 successor picat", succ == NULL);
	succ = successor(tree, 99);
	sd_assert("Problema5 - Test14 successor picat", succ != NULL && succ->value == 100);
	freeTree(&tree);
...
static char *test_predecessor() {
	...
	sd_assert("Problema6 - Test1 predecessor picat", pred != NULL && pred->value == -8);
	pred = predecessor(tree, 7);
	sd_assert("Problema6 - Test2 predecessor picat", pred != NULL && pred->value == 6);
	pred = predecessor(tree, 8);
	sd_assert("Problema6 - Test3 predecessor picat", pred != NULL && pred->value == 7);
	pred = predecessor(tree, -8);
	sd_assert("Problema6 - Test4 predecessor picat", pred == NULL);
	freeTree(&tree);
	...
	sd_assert("Problema6 - Test5 predecessor picat", pred != NULL && pred->value == 1);
	pred = predecessor(tree, 9);
	sd_assert("Problema6 - Test6 predecessor picat", pred != NULL && pred->value == 8);
	pred = predecessor(tree, 25);
	sd_assert("Problema6 - Test7 predecessor picat", pred != NULL && pred->value == 12);
	pred = predecessor(tree, 12);
	sd_assert("Problema6 - Test8 predecessor picat", pred != NULL && pred->value == 9);
	pred = predecessor(tree, 26);
	sd_assert("Problema6 - Test9 predecessor picat", pred != NULL && pred->value == 25);
	freeTree(&tree);
	...
	pred = predecessor(tree, 9);
	sd_assert("Problema6 - Test10 predecessor picat", pred != NULL && pred->value == 4);
	pred = predecessor(tree, 90);
	sd_assert("Problema6 - Test11 predecessor picat", pred != NULL && pred->value == 68);
	pred = predecessor(tree, 50);
	sd_assert("Problema6 - Test12 predecessor picat", pred != NULL && pred->value == 47);
	pred = predecessor(tree, 37);
	sd_assert("Problema6 - Test13 predecessor picat", pred != NULL && pred->value == 35);
	pred = predecessor(tree, 4);
	sd_assert("Problema6 - Test14 predecessor picat", pred == NULL);
	pred = predecessor(tree, 100);
	sd_assert("Problema6 - Test14 predecessor picat", pred != NULL && pred->value == 99);
	pred = predecessor(tree, 68);
	sd_assert("Problema6 - Test14 predecessor picat", pred != NULL && pred->value == 50);
...
static char *all_tests() {
	sd_run_test(test_contains, 1);
	sd_run_test(test_minmax, 1);
	sd_run_test(test_delete, 2);
	sd_run_test(test_lca, 2);
	sd_run_test(test_successor, 2);
	sd_run_test(test_predecessor, 2);
	return 0;
}
